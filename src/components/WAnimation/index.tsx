...
const WAnimation = (props:WAnimationProps) => {
  ...
  const W_700_BLEND_MODE_MULTIPLY_MP4_VIDEO_URL = '/video/w_700_blend_mode_multiply.mp4'
  const W_1300_BLEND_MODE_MULTIPLY_MP4_VIDEO_URL = '/video/w_1300_blend_mode_multiply.mp4'
